...
r.get("/", asyncHandler(ctrl.list));
 r.get("/search", searchCriteria, asyncHandler(ctrl.getByCriteria)); // secured
 r.get("/search-vuln", asyncHandler(ctrl.getByCriteriaVuln));       // vulnerable
...
console.log({
  ...
  getByCriteriaVuln: typeof ctrl.getByCriteriaVuln,
